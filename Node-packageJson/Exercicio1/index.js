...
R: Devemos digitar o seguinte na linha de comando, para passar os parâmetros:
node ./nome-arquivo.js valor
Tem que atribuir o process.argv[2](numero 2 que seria o indice) à uma variável para poder acessá-la.
